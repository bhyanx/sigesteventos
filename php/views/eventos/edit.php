...
$query = "SELECT id_evento, titulo, id_categoria, descripcion, ubicacion, fecha_evento, hora_inicio, hora_fin, max_participantes, tarifa_inscripcion 
          FROM eventos 
          WHERE id_evento = :id";
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE eventos 
              SET titulo = :titulo,
                  ...
                  tarifa_inscripcion = :tarifa_inscripcion
              WHERE id_evento = :id";
                                    ...
                                    <select class="form-select" id="id_categoria" name="id_categoria" required>
                                        ...
                                        <?php foreach ($categorias as $categoria): ?>
                                            <option value="<?php echo $categoria['id_categoria']; ?>" 
                                                    <?php echo $evento['id_categoria'] == $categoria['id_categoria'] ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="fecha_evento" name="fecha_evento" 
                                           value="<?php echo date('Y-m-d', strtotime($evento['fecha_evento'])); ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label for="hora_inicio" class="form-label">Hora de Inicio</label>
                                    <input type="time" class="form-control" id="hora_inicio" name="hora_inicio" 
                                           value="<?php echo date('H:i', strtotime($evento['hora_inicio'])); ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label for="hora_fin" class="form-label">Hora de Fin</label>
                                    <input type="time" class="form-control" id="hora_fin" name="hora_fin" 
                                           value="<?php echo date('H:i', strtotime($evento['hora_fin'])); ?>" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_participantes" name="max_participantes" 
                                           value="<?php echo $evento['max_participantes']; ?>" min="0">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="tarifa_inscripcion" name="tarifa_inscripcion" 
                                               value="<?php echo $evento['tarifa_inscripcion']; ?>" step="0.01" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
